...
<div class="page"> 
    ...
    <div class="body">
        ...
        <div class='sm-text'> The data parsing process involved importing datetime modules, creating dictionaries mapping integers to days, and lots of meticulous string concatenation to output the desired format.</div>
